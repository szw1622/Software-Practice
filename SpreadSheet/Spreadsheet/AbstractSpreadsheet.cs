...
namespace SS
{
    ...
    ///   (1) it starts with one or more letters
    ///   (2) it ends with one or more numbers (digits)
    /// 
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// 
        /// The input start named cell is the cell that changes its content
        /// 
        /// Stores start named cell and cells that related to input start named cell to changed LinkedList
        /// 
        /// Throws CircularException if having Circular Dependency(caused by changing start input named cell's content
        /// </summary>
